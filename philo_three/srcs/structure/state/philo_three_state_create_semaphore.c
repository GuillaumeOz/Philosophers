...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   philo_three_state_create_semaphore.c               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gozsertt <gozsertt@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/07 15:54:37 by gozsertt          #+#    #+#             */
/*   Updated: 2020/12/07 18:56:30 by gozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	state->write_semaphore_one = sem_open("write_semaphore_one", O_CREAT, 0777, 1);
	...
	state->write_semaphore_two = sem_open("write_semaphore_two", O_CREAT, 0777, 1);
